    ...
    <header className="bg-gray-900 text-white p-4 flex justify-between items-center border-b border-gray-700">
      <div className="flex items-center space-x-4">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/reader/leaderboard" className="hover:text-blue-500 transition">Leaderboard</Link>
          <Link href="/reader/contact" className="hover:text-blue-500 transition">Contact</Link>
        </nav>
      </div>
      <div className="flex items-center space-x-4">
        {session ? (
